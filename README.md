...
**Academic projects:**  
1. Grimoire Guide - NLP powered chatbot that searches the best books for the users based on the descriptions provided by them.
2. Binge Trend - Media and entertainment website, which leverages and nlp and machine learning for it's recommendation system.
3. Noral - AI driven oral healthcare appointment system.
