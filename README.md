[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F7CC07&random=false&width=435&lines=I'm+Adi%2C;a+python+developer%2C;who+automates+stuff%2C;and+creates+machine+learning+models)](https://git.io/typing-svg)
...
I use libraries like **Numpy, Pandas, Matplotlib, Seabron, Scikit-learn**, to do stuff like EDA, and creating machine learning models.  
As you all know, I'm primarily a python developer, but I also know c, c++ and java. Here's a fun fact, I first learned java, and then after that I learned c++ XD.   
